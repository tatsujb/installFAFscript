...
echo "";
sudo echo "";
echo "[$(date --rfc-3339=seconds)] T2 begining install of$to_be_installed" >> ~/faf.sh-$faf_sh_version.log;
if [ ! $(command -v steam) ];
...
echo "[$(date --rfc-3339=seconds)] T2 finished succesfully" >> ~/faf.sh-$faf_sh_version.log;
